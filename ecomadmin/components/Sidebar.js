...
import {
    Car, LayoutDashboard, Package, ShoppingBag, Users, ArrowLeftRight, LogOut, Menu, X, ChevronRight, RotateCcw, DollarSign
} from "lucide-react";

const adminLinks = [
    { href: "/", label: "Dashboard", icon: LayoutDashboard },
    { href: "/products", label: "Product Management", icon: Package },
    { href: "/vendors", label: "Vendor Approvals", icon: Users },
    { href: "/orders", label: "Orders", icon: ShoppingBag },
    { href: "/refunds", label: "Refunds", icon: RotateCcw },
    { href: "/payouts", label: "Payouts", icon: DollarSign },
    { href: "/trade", label: "Smart Trade", icon: ArrowLeftRight },
];
        ...
        <div className="flex flex-col h-full bg-[#BFFCF6]">
            <div className="flex items-center justify-between px-6 py-8">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <div className="font-black text-slate-900 text-lg tracking-tight leading-none uppercase">PH-ADMIN</div>
            ...
            <div className="px-4 py-2 border-t border-slate-900/10">
                <Link href={process.env.NEXT_PUBLIC_STORE_URL || "http://localhost:3000"} className="flex items-center gap-3 px-4 py-3 rounded-xl text-slate-500 hover:text-slate-900 transition-all text-xs font-bold">
